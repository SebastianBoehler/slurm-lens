...
- This is a standalone read-only dashboard with live REST service mode, SQLite history and explicit demo/recording modes. Do not import a research project's code,
