...
export function workloadTable(frame,grouping,measure) {
  ...
  if(!groups.length) return '<p class="history-empty">No current jobs in the latest update. Earlier observations are not counted.</p>';
